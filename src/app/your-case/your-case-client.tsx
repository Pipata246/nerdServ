...
const STEPS = [
  {
    ...
    description: "Вы оставляете заявку или пишете напрямую в Telegram. Я отвечаю в течение часа в рабочее время. На этом этапе мы просто знакомимся — никакого давления и продаж.",
    details: [
      "Ответ в течение 1 часа",
      "Без скриптов и шаблонных ответов",
      "Первичная оценка задачи бесплатно",
      "Удобный канал связи — ваш выбор"
    ],
  ...
  },
  {
    ...
    description: "Я задаю точные вопросы о вашем бизнесе, аудитории, конкурентах и ожиданиях. Не шаблонный бриф на 40 пунктов, а живой разговор, который помогает понять суть задачи.",
    details: [
      "Анализ конкурентов и рынка",
      "Определение целевой аудитории",
      "Фиксация KPI и критериев успеха",
  ...
  },
  {
    number: "03",
    tag: "Планирование",
    title: "Техническое задание и смета",
    duration: "День 2–3",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-8 w-8">
    ...
    description: "Получаете подробное ТЗ с описанием каждого экрана, функции и интеграции. Смета разбита по этапам — вы точно знаете, за что платите и когда. Никаких скрытых доплат.",
    details: [
      "Детальное ТЗ с макетами",
      "Смета с разбивкой по этапам",
      "Фиксированные сроки каждого блока",
      "Согласование до старта работ"
    ],
  ...
  },
  {
    ...
    description: "Создаю прототип в Figma — от структуры страниц до финального визуала. Вы видите результат до того, как написана первая строка кода. Правки на этом этапе бесплатны.",
    details: [
      "Wireframe структуры",
      "Финальный дизайн в Figma",
      "Адаптив под мобильные",
      "До 3 итераций правок включено"
    ],
  ...
  },
  {
    ...
    description: "Разработка ведётся итерациями. Каждые 2–3 дня вы получаете апдейт с демо на тестовом сервере. Можете смотреть прогресс в реальном времени и давать обратную связь сразу.",
    details: [
      "Апдейты каждые 2–3 дня",
      "Доступ к тестовому серверу",
      "Чистый и документированный код",
      "Оперативные правки по ходу"
    ],
  ...
  },
  {
    ...
    description: "Полный прогон по всем сценариям: десктоп, мобильные, разные браузеры, пограничные случаи. Проверяю скорость загрузки, SEO-метрики и доступность. Баги фиксируются до релиза.",
    details: [
      "Кросс-браузерное тестирование",
      "Проверка на мобильных устройствах",
      "Lighthouse: скорость и SEO",
  ...
  },
  {
    ...
    description: "Деплой на ваш хостинг или настройка с нуля. Подключаю домен, SSL, настраиваю CDN и кэширование. Первые 24 часа после релиза — на связи в приоритетном режиме.",
    details: [
      "Деплой на ваш сервер или Vercel",
  ...
  },
  {
    ...
    description: "Проект сдан — но это не конец. Слежу за метриками, предлагаю улучшения на основе данных. Клиенты возвращаются за следующими задачами, потому что видят реальный рост.",
    details: [
      "Гарантийный период 30 дней",
      "Обучение работе с CMS",
      "Ежемесячные отчёты по метрикам",
      "Приоритет при следующих задачах"
    ],
