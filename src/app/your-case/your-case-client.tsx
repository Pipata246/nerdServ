...
const STEPS = [
  ...
  {
    number: "04",
    tag: "Вы видите результат заранее",
    ...
    description: "Перед тем как начать делать сайт или бота, вы видите, как это будет выглядеть — на компьютере и телефоне. Если что-то не нравится, меняем сейчас, а не после запуска.",
    details: [
      "Видите внешний вид до начала разработки",
      "Удобно на телефоне — проверяем сразу",
      "Правки на этом этапе — бесплатно",
      "Утверждаете дизайн и только потом стартуем"
    ],
  ...
  },
  {
    ...
    description: "Каждые 2–3 дня вы получаете ссылку на рабочую версию и видите, как растёт проект. Можете смотреть, давать комментарии и вносить правки прямо в процессе — не ждать финала.",
    details: [
      "Обновления каждые 2–3 дня",
      "Ссылка на рабочую версию — всегда доступна",
      "Правки принимаем сразу, не копим",
      "Вы в курсе на каждом шаге"
    ],
  ...
  {
    number: "06",
    tag: "Проверка перед сдачей",
    title: "Всё работает — на любом устройстве",
    duration: "День 21–24",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-8 w-8">
    ...
    description: "Перед тем как передать вам проект, я проверяю всё сам: открываю на телефоне, планшете, компьютере, в разных браузерах. Убеждаюсь, что формы работают, страницы грузятся быстро, ничего не ломается.",
    details: [
      "Проверено на телефоне, планшете и компьютере",
      "Все кнопки и формы работают корректно",
      "Страницы загружаются быстро",
      "Вы получаете готовый продукт, а не сырой"
    ],
  ...
  },
  {
    ...
    details: [
      "30 дней гарантии — исправляю бесплатно",
